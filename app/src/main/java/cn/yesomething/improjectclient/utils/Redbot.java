...
public class Redbot extends View {
    private static final String TAG = "Redbot";
     ...
     * @return
     */
    public Redbot setBadgeMargins(int left, int top, int right, int bottom) {
        leftMargin = left;
        topMargin = top;
        rightMargin = right;
        bottomMargin = bottom;
     ...
     * @return
     */
    public Redbot setBadgeCenterVertical(  ) {
     ...
     * @return
     */
    public Redbot setBadgeType(@Type int type) {
        this.type = type;
        return this;
    }
     ...
     * @return
     */
    public Redbot setBadgeTextSize(int textSize) {
     ...
     * @return
     */
    public Redbot setBadgeTextColor(int textColor) {
     ...
     * @return
     */
    public Redbot setBadgeOverlap(boolean isOverlap) {
     ...
     * @return
     */
    public Redbot setBadgeOverlap(boolean isOverlap, boolean isIgnoreTargetPadding) {
        this.isOverlap = isOverlap;
     ...
     * @return
     */
    public Redbot setBadgeColor(int mBadgeColor) {
     ...
     * @return
     */
    public Redbot setBadgeSize(int w, int h) {
        this.w = w;
        this.h = h;
        return this;
    }
